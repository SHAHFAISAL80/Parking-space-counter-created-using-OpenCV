...
try:
    with open(r'C:\Users\Atif Traders\Videos\park\Parking_space_counter-main\park_positions', 'rb') as f:
...
def mouse_events(event, x, y, flag, param):
    ...
    with open(r'C:\Users\Atif Traders\Videos\park\Parking_space_counter-main\input\parking.png', 'wb') as f:
        pickle.dump(park_positions, f)


while True:

    img = cv2.imread(r'C:\Users\Atif Traders\Videos\park\Parking_space_counter-main\input\parking.png')
